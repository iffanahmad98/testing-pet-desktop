...
{
    public class NPCLootHunter : BaseEntityAI
    {
        public Vector2Int destinationTile;
        [Header ("NPC Loot Hunter")]
        [HideInInspector] public HotelFacilitiesLootDetector hotelFacilitiesLootDetector;
